...
helm.sh/chart: {{ include "mail-mcp.chart" . }}
{{ include "mail-mcp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "mail-mcp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mail-mcp.name" .) .Values.serviceAccount.name }}
{{- else }}
...
ArgoCD Syncwave
*/}}
{{- define "mail-mcp.argocd-syncwave" -}}
{{- if .Values.argocd }}
